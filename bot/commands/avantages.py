...
INVITE_TIERS = [
    {
        ...
        "name":     "🐦‍🔥 Initié",
        "benefits": [
            "**−5 %** sur tout le market (affiché dans le ticket de commande)",
        ],
    },
    {
        "min":      10,
        "name":     "🐦‍🔥 Marchand Elite",
        "benefits": [
            "**−10 %** sur tout le market (affiché dans le ticket de commande)",
    ...
    },
    {
        ...
        "name":     "🐦‍🔥 Maître Phénix",
        "benefits": [
            "**−20 %** sur tout le market (affiché dans le ticket de commande)",
            "Réservation prioritaire des items",
        ],
    },
]
