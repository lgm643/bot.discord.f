...
class GiveawayView(discord.ui.View):
    def __init__(self, msg_id: int):
        ...
        self.msg_id = msg_id
        # FIX : custom_id unique par message.
        # Avec un custom_id fixe ("giveaway_participer"), discord.py ne peut enregistrer
        # qu'une seule vue → tous les giveaways sauf le dernier perdaient leurs boutons.
        # On utilise le msg_id comme suffixe pour rendre chaque vue unique.
        # Pour bot.add_view() au démarrage (ready.py), on passe msg_id=0 comme placeholder ;
        # le bot re-enregistre les vues actives dans _restore_active_giveaways().
