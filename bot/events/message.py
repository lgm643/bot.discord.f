"""
events/message.py — Événements messages.

CORRECTIONS v3 :
  - on_message_delete et on_message_edit supprimés d'ici.
    Ils sont désormais gérés uniquement dans logs_events.py
    pour éviter les logs en double.
  - on_message conservé : anti-spam, filtrage liens, XP.
"""
import asyncio
import random
import re
...
from bot.utils.logs import send_log, log_lien_bloque, log_antispam_warn, log_antispam_kick, log_antispam_mute
